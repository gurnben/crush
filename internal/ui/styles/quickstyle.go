...
func quickStyle(o quickStyleOpts) Styles {
	...
	s.Editor.PromptAutoIconFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.fgMostSubtle).Background(o.primary).Bold(true).SetString(" A ")
	s.Editor.PromptAutoIconBlurred = s.Editor.PromptAutoIconFocused.Foreground(o.bgBase).Background(o.fgMoreSubtle)
	s.Editor.PromptAutoDotsFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.primary).SetString(":::")
