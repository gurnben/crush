...
func init() {
	...
	rootCmd.Flags().BoolP("auto", "a", false, "Use a classifier model to auto-approve safe tool calls")
	rootCmd.MarkFlagsMutuallyExclusive("yolo", "auto")
...
func setupLocalWorkspace(cmd *cobra.Command) (workspace.Workspace, func(), error) {
	...
	store.Overrides().AutoMode = autoMode
